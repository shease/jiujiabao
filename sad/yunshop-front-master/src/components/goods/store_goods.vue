        ...
        <div id="goods">
            ...
            <el-row>
                ...
                <el-col v-if="is_o2o">
                    ...
                    <div v-else>
                        <div>
                            <el-button type="success" style="padding: 10px 15px;float: right;" @click='addCart1(goodsInfo)'>加入购物车</el-button>
                        </div>
                    </div>
                </el-col>
            ...
            <div id="foot" v-if="!is_o2o">
                ...
                <div class="cservice" v-if="!is_o2o&&cservice && isMiniApp">
                    <div @click="gotoMiniAppCs">
                        <i class="iconfont icon-kefu"></i>客服</div>
                </div>
...
<script>
  import goods from './store_goods_controller';
