    ...
    <transition name="fade2">
        <div id="goods">
            ...
            <div id="foot">
                ...
                <div class="addfav"  v-if="!is_o2o&&cservice && !isMiniApp">
                    <a :href="cservice">
            ...
            <div id="shopInfo" ref='goodinfo' :class="{goodTop:goodTop==true,bottomMargin:isMarginBottom}" >
                <div id="tabs">
                    <div style="height: 30px;padding-left: 20px;line-height: 20px;text-align: left;font-size: 20px">门店地址</div>
                    <div style="padding-left: 10px;line-height: 20px;text-align: left;font-size: 16px;border-bottom:1px solid lightgrey" v-for="item in Adaddress">
                        {{item.adress}}
                    </div>
