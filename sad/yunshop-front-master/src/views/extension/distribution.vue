<template>
    <div class="distribution" id="distribution">
        ...
        <!--<ul id="gongge">-->
            <!--<li>-->
    <!---->
                <!--&lt;!&ndash;<router-link :to="{name:'commission',query:{i:toi}}">&ndash;&gt;-->
            ...
            <!--<li>-->
    <!---->
                <!--&lt;!&ndash;<router-link :to="{name:'unsettled',query:{i:toi}}">&ndash;&gt;-->
            ...
            <!--<li>-->
    <!---->
                <!--&lt;!&ndash;<router-link :to="{name:'alreadySettled',query:{i:toi}}">&ndash;&gt;-->
            ...
            <!--<li>-->
    <!---->
                <!--&lt;!&ndash;<router-link :to="{name:'notPresent',query:{i:toi}}">&ndash;&gt;-->
            ...
            <!--<li>-->
    <!---->
                <!--&lt;!&ndash;<router-link :to="{name:'present',query:{i:toi}}">&ndash;&gt;-->
