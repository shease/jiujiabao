...
export default {
  data() {
    return {
      ...
      withdrawToAlipay: 0,
      //提现总金额
      totalwithdrawal: sessionStorage.ha,
      //手续费
      poundage: 0.00,
      //劳务税
      servicetax: 0.00,
  ...
  activated() {
    ...
    this.unAllCheckList = [];
    this.datasource = [];
    this.totalwithdrawal = sessionStorage.ha;
    this.poundage = '0.00';
  ...
  methods:
    ...
    initEup(data) {
      ...
      countTotalPrice() {
        //提现总金额
        this.totalwithdrawal = sessionStorage.ha;//初始化
        //手续费
      ...
      withdrawToBalance(type) {
        ...
        // if (this.checkList.length > 0) {
          var data = { total: { amounts: this.totalwithdrawal, poundage: this.poundage, pay_way: type }, withdrawal: sessionStorage.ha };
          var that = this;
          //finance.Income-withdraw.save-withdraw


          window.location.href='https://admin.zhongxinheli.com/api/tixian.php?money='+sessionStorage.ha+'&member_id='+localStorage.uid;
