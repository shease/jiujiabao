      ...
      <div id="member" style="position:relative;">
        ...
        <div id="userinfo">
          ...
          <ul>
            <li v-if="isWithdraw">
              <router-link :to="fun.getUrl('extension')">
                <span style="font-size: 15px">{{picMa.surplus}}</span>
                <br><span style="font-size: 14px;color: #8c8c8c">分享扫码个数</span>
              </router-link>
            </li>
            <li v-if="isWithdraw">
              <router-link :to="fun.getUrl('extension')">
                <span style="font-size: 15px">{{picMa.surplus}}</span>
                <br><span style="font-size: 14px;color: #8c8c8c">分享已核销</span>
              </router-link>
            </li>
          </ul>
        </div>
        ...
        <div id="tool">
          ...
          <ul class="tool-box">
            ...
            <li @click="openQrCode('block')">

              <img src="../../assets/images/tool-g.png">
              <div>自提二维码</div>
            </li>
            <li>
              <router-link to="/member/message">
        ...
        <div class="cart">
          ...
          <router-link v-if='signs' :to="fun.getUrl('sign')"><!--is_sign -->
            <div class="list1" style="border:none">
              <yd-icon slot="icon" class="iconfont icon-member-clock1" custom size="1.625rem" color="#f15353"
          ...
          <router-link v-if="store_set && store_set.is_open_cashier==1" :to="fun.getUrl('cashier')">
            <div class="list1">
              <yd-icon slot="icon" class="icon-member-cashier" custom size="1.625rem" color="#f15353"
                       style="margin-right:0.375rem"></yd-icon>
          ...
          <router-link :to="fun.getUrl('extension')" v-if="is_extension">
            <div class="list1">
              <yd-icon slot="icon" class="icon-member-extension1" custom size="1.625rem" color="#f15353"
                       style="margin-right:0.375rem"></yd-icon>
          ...
          <router-link v-if="haveShop==1" :to="fun.getUrl('microShop_home')">
            <div class="list1">
              <yd-icon slot="icon" class="icon-member-mendian1" custom size="1.625rem" color="#f15353"
                       style="margin-right:0.375rem"></yd-icon>
          ...
          <router-link v-else-if="haveShop==0" :to="fun.getUrl('microShop_apply')">
            <div class="list1">
              <yd-icon slot="icon" class="icon-member-my-shop1" custom size="1.625rem" color="#f15353"
                       style="margin-right:0.375rem"></yd-icon>
          ...
          <div id="service" v-if="isELive">
            <router-link :to="fun.getUrl('lifeService')">
              <div class="list1">
                <yd-icon slot="icon" class="icon-member-life-pay1" custom size="1.625rem" color="#f15353"
                         style="margin-right:0.375rem"></yd-icon>
          ...
          <router-link v-if="isLove" :to="fun.getUrl('love_index')">
            <div class="list1">
              <yd-icon slot="icon" class="icon-member-exchange1" custom size="1.625rem" color="#f15353"
                       style="margin-right:0.375rem"></yd-icon>
          ...
          <router-link v-if="coin" :to="fun.getUrl('overseas_index')">
            <div class="list1">
              <yd-icon slot="icon" class="icon-member-currency1" custom size="1.625rem" color="#f15353"
                       style="margin-right:0.375rem"></yd-icon>
          ...
          <router-link v-if="is_stroeWithdraw" :to="fun.getUrl('storeManage')">
            <div class="list1">
              <yd-icon slot="icon" class="icon-member-cash1" custom size="1.625rem" color="#f15353"
                       style="margin-right:0.375rem"></yd-icon>
          ...
          <router-link v-if="helps" :to="fun.getUrl('helpcenter')">
            <div class="list1">
              <yd-icon slot="icon" class="icon-member-help" custom size="1.625rem" color="#f15353"
                       style="margin-right:0.375rem"></yd-icon>
          ...
          <router-link v-if="is_froze" :to="fun.getUrl('FrozenCoin')">
            <div class="list1">
              <yd-icon slot="icon" class="icon-member-frozen1" custom size="1.625rem" color="#f15353"
                       style="margin-right:0.375rem"></yd-icon>
          ...
          <div>
            <div class="list1" v-for="item in pluginsList" @click="pluginGoto(item)">
              <yd-icon slot="icon" :class="item.class" custom size="1.625rem" color="#f15353"
                       style="margin-right:0.375rem"></yd-icon>
