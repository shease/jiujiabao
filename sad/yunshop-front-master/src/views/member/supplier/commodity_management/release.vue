<template>
  <section id="goods-release">
    ...
    <section style="height: 48px;background: white;margin-top: 10px;line-height: 48px;" ref="classify">
    ...
    <section id="edit-b">
      <div class="top">
        ...
        <div style="text-align: center;">
          <div>
            <el-upload :action="uploadUrl" :on-preview="handlePreview" :limit="1" list-type="picture-card"
                       :show-file-list="false" :on-exceed="handleExceed" :before-upload="beforeUpload"
    ...
    <section style="background: white;margin-top:0.625rem;padding-bottom: 10px;box-sizing: border-box">
      ...
      <div style="text-align: center;">
        <el-upload class="upload-demo" :data="{'attach':'upload'}" :on-change="handleChange" :action="uploadUrl"
                   :on-preview="handlePreview" :on-remove="handleAptiRemove" :file-list="fileList2"
                   list-type="picture-card" :on-exceed="handleExceed" :before-upload="beforeUpload"
          ...
          <div style="width: 100%;height: 100%;background: rgba(45,45,45,0);position: relative;">
            ...
            <div
                ...
                @click.stop="occlusion()" v-if="upNumMax>=4">
            </div>
          </div>
        </el-upload>
      </div>
    ...
    <section style="background: white;margin-top:0.625rem;padding-bottom: 10px;box-sizing: border-box">
      ...
      <div style="text-align: center;">
        <el-upload class="upload-demo" :data="{'attach':'upload'}" :on-change="handleChangeOther" :action="uploadUrl"
                   :on-preview="handlePreview" :on-remove="handleAptiRemoveOther" :file-list="fileList4"
                   list-type="picture-card" :on-exceed="handleExceed" :before-upload="beforeUpload"
                   :on-success="handleAptiSuccessOther">
          <div style="width: 100%;height: 100%;background: rgba(45,45,45,0);position: relative;">
            <i class="el-icon-plus"></i>
            <div
                style="width: 100%;height: 100%;background: rgba(45,45,45,0);position: absolute;left: 0px;top:0px;z-index: 2;"
                @click.stop="occlusionOther()" v-if="upNumMaxOther>=4">
            </div>
          </div>
        </el-upload>
      </div>
