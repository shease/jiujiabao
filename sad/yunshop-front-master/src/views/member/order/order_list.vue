<template>
	<div id="payment">
		...
		<mt-navbar v-model="selected" style="z-index:98;height:2.75rem;line-height:2.75rem;"
			...
			<mt-tab-item id="5"
						 @click.native="swichTabTItem">待扫描</mt-tab-item>
			<mt-tab-item id="4"
			             @click.native="swichTabTItem">已完成</mt-tab-item>
		</mt-navbar>
		<mt-loadmore v-if="goload" :top-method="loadTop" :bottom-method="loadBottom" :bottom-all-loaded="allLoaded" ref="loadmore" bottomPullText='' bottomDropText='上拉加载...' bottomLoadingText='' :autoFill='true' id='olis'>
			<mt-tab-container v-model="selected">
				...
				<mt-tab-container-item id="5">
					<cOrderList v-on:ConfrimOrderNotification="cofirmOrderAction" v-on:ToDetailNotification="toDetail" :datasource="waitsaomiao" :orderType="orderType" :detailUrl="detailUrl" :status="5" class='osll'></cOrderList>
				</mt-tab-container-item>
