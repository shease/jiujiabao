<template>
  <div id="all">
    ...
    <div class="home">
      <div :class="{'search':'ture','mout':amout,isfollow}" id="d1">
        <div class="location" @click='tolocation'>
          <i class="fa fa-map-marker" style="margin-right:2%"></i>{{address}}<i class="fa fa-angle-down"
    ...
    <div class="c-swipe" style="height:11.25rem">
      <mt-swipe :auto="4000">
        <mt-swipe-item v-if="carousels" v-for="(slide,index) in carousels" :key="index"
    ...
    <div>
      ...
      <c-storeList @changList="getMoreData" :stores='stores' :loading='loading' text='附近的店铺' :page="page" :totalPage='total_page'></c-storeList>
      <!-- </mt-loadmore> -->
    </div>
