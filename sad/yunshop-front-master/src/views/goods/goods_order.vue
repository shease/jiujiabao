<template>
  <div id="goodsinfo">
      ...
      <mt-navbar v-model="selected">
        <template v-for="(item, index) in dispatch">
			...
			<mt-tab-container v-model="selected">
				...
				<mt-tab-container-item id="3"  v-if="zitiYes">
				...
				<mt-tab-container-item id="1" v-if="zitiYes">
						<div class="addr" @click="showAddress" >
						<i class="fa fa-map-marker"></i>
						<p>收件人:{{realname}} {{mobile}}
							<br />
		...
		<div   class="addr" @click="showAddress" v-if="zitiYes">
      <div class="icon" >
          <i class="fa fa-map-marker"></i>
          <p>收件人:{{realname}} {{mobile}}
            <br />
            ...
            <div v-if="!(rent_deposit_free == 0 && rent_free == 0)">
                  ...
                  <div class="right">
					...
					<div class="num list">
						...
						<div class="right" style="color:#E84E40" ref="qumimabide">
							￥{{item.order.order_goods_price}}
						</div>
					</div>
    ...
    <yd-popup v-model="agreementShow" position="right" width="100%">
	  ...
	  <div class="tipPayWay" v-show="getWay1"  style="background: rgba(0,0,0,0.4)">
		  <div class="buziti" @click="kuaidi1">快递</div>
		  <div class="ziti" @click="ziti1">自提</div>
	  </div>
	  <div class="tipPayWay" v-show="getWay2" 	 style="background: rgba(0,0,0,0.4)">
		  <div class="buziti" @click="wuliu2">物流</div>
		  <div class="ziti" @click="ziti2">自提</div>
	  </div>
	</div>
</template>
