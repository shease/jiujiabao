...
export default {
    data() {
        return {
            tipStatus:0,   //提取方式状态码
            getWay1:false,  //提取方式遮罩是否显示
            getWay2:false,  //提取方式遮罩是否显示
            order_data: "",
    ...
    created(){
          // var that = this
           // alert(1)
           //  alert(JSON.stringify(this.$route.params.goodsId))
           // console.log( this.$route.params.goodsId)
           //  if( this.$route.params.goodsId =='7'){
           //      this.MyOtrderId = 7
           //      this.zitiYes = true
           //      this.addressData = [];
           //      let that = this;
           ...
           //              // that.realname = that.addressData[0].username
           //              // that.mobile = that.addressData[0].mobile
           //              // that.mobile = that.addressData[0].
           //              console.log(that.addressData);
           //              that.setAddressViewData(that.addressData[0]);//更新界面 & ID
           ...
           //      });
           //      // const json = {}
           //      // json.address = JSON.stringify({"username":"你好","mobile":"13333333333","zipcode":"","isdefault":"1","province":"河北省","city":"秦皇岛市","district":"北戴河区","address":"达达","street":"海滨镇","uid":localStorage.uid,"uniacid":"1",goods_id:7})
           //      // $http.post('member.member-address.store',json, "提交中...").then(function (response) {
           //      //     console.log(response)
           //      //     alert(JSON.stringify(response))
           //      //     that.clearStorage();
           //      //     that.submit_active = true;
           //      //     that.$router.push(that.fun.getUrl('orderpay', { status: "2", order_ids: response.data.order_ids,goodsID:that.$route.params.goodsId }));
           //      //     // else {
           //      //     //       Toast(response)
           //      //     //   }
           //      // }, function (response) {
    ...
    methods: {
        ...
        submitTrue(){
            ...
            if (this.submit_active == true) {
                ...
                // if(this.MyOtrderId == '7' || this.MyOtrderId == 7){
                //     let that = this;
                //     // let json = this.assembleJson();
                //     // console.log(json)
                //     // json.tipStatus = this.tipStatus
                //     const json = {}
                //     json.address = {"username":"你好","mobile":"13333333333","zipcode":"","isdefault":"1","province":"河北省","city":"秦皇岛市","district":"北戴河区","address":"东华门街道","street":"海滨镇","uniacid":"1",goods_id:7}
                //     // json.dispatch_type_id = 1
                //     // json.newData = {id:'110101001'}
                //     // json.goods = JSON.stringify([{"goods_id":7,"total":1,"option_id":0}])
                //     // json.member_coupon_ids = "[]"
                //     // json.orders = "[]"
                //     // json.tipStatus = 0
                //     console.log(json)
                ...
                //             that.clearStorage();
                //             that.submit_active = true;
                //            // $http.post('order.create', json, "提交中...").then(res=>{
                //               that.$router.push(that.fun.getUrl('orderpay', { status: "2", order_ids: response.data.order_ids,goodsID:that.$route.params.goodsId }));
                //            // })
                //
                //       // else {
                ...
                // else{
                    if (this.isRent) {
                        ...
                        // }
                        console.log(this.$refs.qumimabide[0].innerText)

                       if(this.$refs.qumimabide[0].innerText == '￥360.00'){

                           this.getWay1 = true
                            return
                        }
                        if(this.$refs.qumimabide[0].innerText == '￥8800.00'){
                            this.getWay2 = true
                            return
                        }
                        let that = this;
       ...
       //跳转到新增地址
        ...
        //提交订单
        submit() {
            // if(this.$refs.qumimabide.innerHTML == 360.00){}
            // this.getWay = true
            this.submitTrue()
        },
