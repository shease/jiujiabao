...
//商家聯盟
const Seller = r => require(['../views/member/supplier/seller'], r);
...
const routes = [
  ...
  { path: '/member/presentationRecord/:supplier', component: PresentationRecord, name: 'supplierRecord', meta: { title: '提现记录', foot: true } },
  ...
  { path: '/member/seller', component: Seller, name: 'seller', meta: { title: '商家聯盟', foot: true } },
  //comment
  ...
  { path: '/member/orderList/:status/:orderType', component: OrderList, name: 'supplierOrderlist', meta: { title: '订单', foot: true } },
  ...
  { path: '/member/orderdetail/:order_id/:orderType', component: Goodsinfo, name: 'supplierOrderdetail', meta: { title: '订单详情', foot: true } },
...
//Train ticket 火车票
  ...
  { path: '/supplier_center/:uid', component: SupplierCenter, name: 'SupplierCenter', meta: { title: '供应商管理' , foot: true} },
  { path: '/commodity_management/:store_id/:store', component: CommodityManagement, name: 'CommodityManagement', meta: { title: '商品管理', foot: true } },
  { path: '/commodity_editor/:store_id/:goods_id/:store', component: CommodityEditor, name: 'CommodityEditor', meta: { title: '商品编辑', foot: true } },
  { path: '/commodity_release/:store_id/:store', component: CommodityRelease, name: 'CommodityRelease', meta: { title: '商品发布', foot: true } },
  //商品分类
  ...
  { path: '/supplier_info_manage/:member_id', component: SupInfoManage, name: 'SupInfoManage', meta: { title: '信息管理' , foot: true} },
